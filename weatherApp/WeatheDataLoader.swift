...
//
//            guard  let safeWeather = weather,
//                   let hourly = safeWeather.hourly,
//                   let daily = safeWeather.daily  else { return }
//
//            let lastHour = min(5,hourly.count)
//            for index  in 0...lastHour {
//
...
//                    let formatedDate = Date(timeIntervalSince1970: hour)
//                    self.hourFormatter.timeZone = TimeZone(identifier: weatherTimeZone)
//                    let transformedHour = self.hourFormatter.string(from: formatedDate)
//
//                    let weatherMy = HourlyWeatherToShow(hour: transformedHour, hourlyTemperature: hourlyTemperature, hourlyWeatherId: hourlyId, weatherDescription: weatherdescription, day: nil, daylyTemperature: nil, daylyWeatherId: nil)
//                    self.hourlyWeatherDataList.append(weatherMy)
//                }
//                for index in 0..<daily.count - 1 {
//                    if  let temperature = daily[index].temperature?.dayTemperature,
//                        let weekDay = daily[index].dt,
...
//                        let day = self.dayFormatter.string(from: formatedDate)
//
//                        let weatherMy2 = HourlyWeatherToShow(hour: nil, hourlyTemperature: nil, hourlyWeatherId: nil, weatherDescription: nil, day: day, daylyTemperature: temperature, daylyWeatherId: dailyId)
//                        self.hourlyWeatherDataList.append(weatherMy2)
//                    }
//                }
//                completion(self.hourlyWeatherDataList, nil)
//            }
